...
- **Timestamp:** 2026-09-14T22:21:18.432Z
...
| **F. Orientation Adaptation** | `PASS` | Observed ROTATION_0 then ROTATION_1 with no command failure |
...
- **Cold Startup (Median):** 701 ms
- **Cold Startup (P90):** 970 ms
- **Rendered Frames:** N/A
...
- **Artifacts Saved:** `test-results\android\2026-09-14T22-21-18-421Z`
